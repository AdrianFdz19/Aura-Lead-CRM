              ...
              <tbody>
                {propertiesWithImages.map((p) => (
                  <tr key={p.id} className="border-t hover:bg-gray-50">
                    ...
                    {/* Ajusta estos campos según lo que devuelve tu DB */}
                    <td className="p-4 text-gray-600">Residencial</td>
                    <td className="p-4"><span className="px-2 py-1 rounded-full bg-green-100 text-green-700 text-xs">Activa</span></td>
                    <td className="p-4">${p.price.toString()}</td>
